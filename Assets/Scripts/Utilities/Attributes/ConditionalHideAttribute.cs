...
public class ConditionalHideAttribute : PropertyAttribute
{
	...
	// Use with [ConditionalHide("variable name")], disables item below line unless conditionalSourceField is true
    ...
    // Use with [ConditionalHide("variable name", true)], hides item below line until conditionalSourceField is true
